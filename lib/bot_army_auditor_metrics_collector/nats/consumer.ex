defmodule BotArmyAuditorMetricsCollector.NATS.Consumer do
  @moduledoc """
  NATS message consumer for auditor_metrics_collector.
  ...
  def handle_continue(:connect, state) do
    case GenServer.call(BotArmyLibraryRuntime.NATS.Connection, :get_connection, 5000) do
      {:ok, conn} ->
        ...
        BotArmyLibraryRuntime.Registry.register("auditor_metrics_collector", @subjects, @version)
