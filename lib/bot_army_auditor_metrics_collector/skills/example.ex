defmodule BotArmyAuditorMetricsCollector.Skills.Example do
  @moduledoc """
  Example skill for Metrics Collector Bot.
  ...
  1. NATS message arrives on trigger subject: `bot.bot_army_auditor_metrics_collector.command.example`
  ...
  5. Result published to response subject: `bot.bot_army_auditor_metrics_collector.response.<request_id>`
  ...
  1. Rename: `lib/bot_army_auditor_metrics_collector/skills/your_skill.ex`
  ...
  def nats_triggers do
    ...
    [
      "bot.bot_army_auditor_metrics_collector.command.example"
    ]
  end
