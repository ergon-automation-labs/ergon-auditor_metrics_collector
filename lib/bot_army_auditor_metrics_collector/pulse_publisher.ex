defmodule BotArmyAuditorMetricsCollector.PulsePublisher do
  @moduledoc """
  Periodic health publisher for Metrics Collector Bot.
  ...
  2. **`bot.auditor_metrics_collector.pulse`** — richer metrics every 30 minutes (lower NATS volume).
  ...
  @service_name "auditor_metrics_collector"
  @envelope_source "bot_army_auditor_metrics_collector"
  ...
  @impl true
  def init(_opts) do
    Logger.info("[PulsePublisher] Starting Metrics Collector Bot pulse publisher")
