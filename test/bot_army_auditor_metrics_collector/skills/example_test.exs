defmodule BotArmyAuditorMetricsCollector.Skills.ExampleTest do
  @moduledoc """
  ...
  alias BotArmyAuditorMetricsCollector.Skills.Example
  ...
  describe "nats_triggers/0" do
    test "returns list of trigger subjects" do
      ...
      assert "bot.bot_army_auditor_metrics_collector.command.example" in triggers
    end
  end
