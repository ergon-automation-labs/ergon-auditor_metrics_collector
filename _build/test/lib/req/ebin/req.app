{application,req,
             [{config_mtime,1788734432},
              {optional_applications,[nimble_csv,plug,brotli]},
              {applications,[kernel,stdlib,elixir,logger,finch,mime,jason,
                             nimble_csv,plug,brotli]},
              {description,"req"},
              {modules,['Elixir.Collectable.Req.Utils.CollectWithHash',
                        ...
                        'Elixir.Req.Finch','Elixir.Req.Gzip',
                        'Elixir.Req.HTTPError','Elixir.Req.Plug',
                        'Elixir.Req.Plug.Adapter','Elixir.Req.Request',
                        'Elixir.Req.Response','Elixir.Req.Response.Async',
                        'Elixir.Req.Steps','Elixir.Req.Tar','Elixir.Req.Test',
